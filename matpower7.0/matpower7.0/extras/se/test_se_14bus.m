...
idx.idx_zPinj = [1;2;3;6;8];
idx.idx_zQinj = [1;2;3;6;8];
...
measure.Pinj = [-2.32; -0.183; 0.94; 0.111; 0];
measure.Qinj = [0.17; -0.308; -0.044; -0.047; -0.174];
...
sigma.sigma_Vm = 0.01;
sigma.sigma_Pinj = 0.01;
sigma.sigma_Qinj = 0.01;
